...
(if (eq system-type 'gnu/linux)
  (progn
    ...
    (custom-set-faces
     ...
     '(default ((t (:inherit nil :stipple nil :background nil :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :foundry "unknown" :family "Droid Sans Mono")))))
  )
)
